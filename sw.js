const CACHE="prado-v2-1";
const ASSETS=["./","./index.html","./css/styles.css","./js/app.js","./js/auth.js","./js/firebase.js","./js/entregas-service.js","./js/utils.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
